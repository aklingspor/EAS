...
class marketStack{ 
    ...
    //Available at https://marketstack.com/product 
    protected $apiKey = '08d9a9c3b45bf0be7f7627fbc557f953'; 

    //API endpoints 
    private $endPoint = array( 
        'eod' => 'api.marketstack.com/v1/eod', 
        'intraday' => 'api.marketstack.com/v1/intraday', 
        'tickers' => 'api.marketstack.com/v1/tickers', 
        'exchanges' => 'api.marketstack.com/v1/exchanges', 
        'currencies' => 'api.marketstack.com/v1/currencies', 
        'timezones' => 'api.marketstack.com/v1/timezones' 
    ); 
